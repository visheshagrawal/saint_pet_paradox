...
<H1>REAL GAME</H1>
                ...
                <p>
                        This is the real game.You will only be given one attempt. You have to press the button.It will generate the amount you win. The amount that comes in this round will be the points provided to you.
                        <br><br>
</p>
...
$sql="INSERT INTO game_des(Amount) VALUES ('$Amount')";
...
// 3. Add event handler
button.addEventListener ("click", mathprobReal);
  ...
  //       //value=set;
  //        var timer = setTimeout(function(){window.location="thankyoupage.php?win="+value}, 300);
  //    }
  //       //<p>Game over You will be redirected in 1 second</p>
  //   }


    function mathprobReal(){
      //HEADS
      while(Math.random()<=0.5){
        value=2*value;
      }
      document.getElementById("demo").innerHTML = "Game over!You win Rupees "+value;
        final=value;
        if(value!=2){
        val=value/2;
        val=1/(value);}
        ...
        // window.location.href = "thankyoupage.php?Amount=" + am; 
        //value=set;
         var timer = setTimeout(function(){window.location="thankyoupageDes.php?win="+value}, 400);
     }
