...
<form  method="POST" action="check_aptitude_Exp.php"><!-- change database name -->
<label for="aptitude">Q. If you allocated INR 1,00,000  in an option last year and the option incurred a gain of 40% in one year, how much would it be worth after the end of the first year?<br></label>
<br><br>
  <label for="aptitude">INR</label>
...
$sql="INSERT INTO demographics_exp5(ID,Age, Gender, Education, Major, Occupation, Marriage,Income,Email) VALUES ('$var','$age','$gender','$education','$major','$occup','$mstatus','$aincome','$email')";
