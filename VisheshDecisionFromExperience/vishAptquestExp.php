...
$sql="INSERT INTO demographics_exp(ID,Age, Gender, Education, Major, Occupation, Marriage,Income,Email) VALUES ('$var','$age','$gender','$education','$major','$occup','$mstatus','$aincome','$email')";
